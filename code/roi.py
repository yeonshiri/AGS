...
def extract_roi_and_split(image_paths, best_path, output_mc_dir, output_sa_dir):
    ...
    exp_folders = glob.glob('/yolov5/runs/detect/exp*')       # 데탑 로컬 경로
